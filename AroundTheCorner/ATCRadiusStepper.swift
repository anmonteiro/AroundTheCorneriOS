//
//  ATCRadiusStepper.swift
//  AroundTheCorner
//
//  Created by António Nuno Monteiro on 24/12/15.
//  Copyright © 2015 António Nuno Monteiro. All rights reserved.
//

import UIKit

@IBDesignable public class ATCRadiusStepper : UIControl {
  ...
  @IBInspectable public var buttonsTextColor: UIColor = UIColor(red: 0.0, green: 122.0/255.0, blue: 1.0, alpha: 1.0) {
    didSet {
  ...
  @IBInspectable public var buttonsBackgroundColor: UIColor = UIColor.whiteColor() {
    didSet {
      for button in [leftButton, rightButton] {
  ...
  /// Font of the buttons.
  public var buttonsFont = UIFont.systemFontOfSize(22.0, weight: UIFontWeightBold) {
    didSet {
      for button in [leftButton, rightButton] {
  ...
  @IBInspectable public var labelTextColor: UIColor = UIColor(red: 0.0, green: 122.0/255.0, blue: 1.0, alpha: 1.0) {
    didSet {
  ...
  @IBInspectable public var labelBackgroundColor: UIColor = UIColor.whiteColor() {
    didSet {
      label.backgroundColor = labelBackgroundColor
    }
  }
  
  public var labelFont = UIFont.systemFontOfSize(22.0) {
    didSet {
  ...
  public override func layoutSubviews() {
    ...
    leftButton.layer.borderColor = UIColor(red: 0.0, green: 122.0/255.0, blue: 1.0, alpha: 1.0).CGColor
    leftButton.layer.cornerRadius = 4.0

    rightButton.layer.borderWidth = 1.5
    rightButton.layer.borderColor = UIColor(red: 0.0, green: 122.0/255.0, blue: 1.0, alpha: 1.0).CGColor
